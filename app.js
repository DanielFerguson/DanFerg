        ...
        projects: [
            {
                ...
                description: 'HelpingHomes is a free platform connecting evacuees to their local good samaritans, around Australia.',
                links: [
                    {
                        name: 'Website',
                ...
                tags: ['HelpingGroup', 'Web', 'Spatial', 'AWS', 'JS', 'Vue', 'Mapbox', 'Lambda']
            },
            {
                title: 'SupportThem',
                image: 'assets/supportthem.svg',
                description: 'SupportThem is a platform where consumers will be able to visually explore rural and regional communities and learn about what makes them so unique.',
                links: [
                    {
                        name: 'Read More',
                ...
                tags: ['In Progress', 'HelpingGroup', 'Serverless', 'AWS', 'JS', 'Vue', 'Lambda', 'Auth0', 'CI/CD', 'Cloudflare']
            },
            {
                title: 'OurMove',
                image: 'assets/ourmove.svg',
                description: 'A central network that enables people to directly care for one another and post what they may need help with themselves.',
                links: [
                    {
                        name: 'Read More',
                ...
                tags: ['Reworking', 'HelpingGroup', 'AWS', 'JS', 'Vue', 'PHP', 'Laravel', 'Auth0']
            },
            {
                title: 'Traffic Flow Prediction Model',
                image: 'assets/melbourne.jpg',
                description: 'Combining machine learning and web apps, the TFPM project was about creating accurate prediction of driving times between points. These predictions were based on VicRoads traffic data, rainfall, day of the week and more.',
                links: [
                    {
                        name: 'Source',
                ...
                tags: [
                    'Machine Learning', 'Client-side', 'Tensorflow', 'TFJS', 'JS', 'Python', 'Mapbox', 'Vue'
                ]
            },
            {
                title: 'RISCy-Pong',
                image: '',
                description: 'I recreated the classic game, Pong, for the Raspberry Pi. I wrote the application using Assembly code for the Pi 3\'s RISC-V instruction set.',
                links: [
                    {
                        name: 'Source',
            ...
            },
            {
                ...
                description: 'A proof of concept of how a holistic data-driven approach could be used to make better future planning decisions for land zoning.',
                links: [
                    {
                        name: 'Website',
            ...
            },
            {
                ...
                description: 'The Balance Board is a system aimed at solving a problem many face, balance impairment, through conditions like strokes and ABI (Acquired Brain Injury), balance impairment has meant that for some, quality of life has dramatically fallen. ',
                links: [
                    {
                        name: 'Source',
                    ...
                    {
                        name: 'Report',
                        url: 'https://github.com/DanielFerguson/Stroke-Rehabilitation-Board/blob/master/Folio.pdf'
                    }
                ],
            ...
            },
            {
                ...
                description: 'I wanted to create a simple app that I\'d use in my day-to-day life. Nothing revolutionary, but something that helps me finally create a list of awesome recipes that I can reference time and time again.',
                links: [
                    {
                        name: 'Source',
        ...
        experience: [
            {
                ...
                from: 'Jan 2020',
                to: 'Present',
                role: 'Being the founder and director of the HelpingGroup, my role consists of overseeing the development of our initatives, liasing with department heads and partners, and leading the technical development of the platforms.',
                projects: [
                    'SupportThem',
                    'OurMove',
                    'HelpingHomes'
        ...
        talks: [
            {
                ...
                subtitle: '',
                description: 'Why it’s important for federal, state and local governments, and local communities to foster entrepreneurial ecosystems amongst Australian small and medium enterprises (SMEs).',
                date: 'May, 2020',
            ...
            },
            {
                ...
                subtitle: '',
                description: 'Discussed how I began my leadership journey, what I\'ve learned through being involved in leadership and how these expereinces have opened up new avenues.',
                date: 'April, 2020',
